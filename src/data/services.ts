...
export const servicesData: ServiceData[] = [
  ...
  {
    id: 'gestione-finanziaria',
    icon: 'lucide:wallet',
    title: 'Gestione Finanziaria',
    shortDescription: 'Soluzioni finanziarie assicurative per la protezione del patrimonio e la pianificazione successoria.',
    description: 'Strumenti assicurativi per la gestione del patrimonio, la pianificazione successoria e la costituzione di capitale',
    benefits: [
      ...
      'Copertura a tutela degli oneri successori',
      'Consulenza personalizzata sulla pianificazione finanziaria',
    ],
    details: [
      'Analizziamo la tua situazione patrimoniale e familiare per individuare le soluzioni assicurative più adatte alla protezione del tuo patrimonio.',
      'Ti proponiamo rendite assicurative, sia immediate che differite, per garantirti un reddito costante nel tempo.',
      'Pianifichiamo la costituzione di capitali a favore di terzi o eredi, per tutelare i tuoi cari e il futuro della tua famiglia.',
      'Ti affianchiamo nella scelta di coperture a tutela degli oneri successori, per una gestione serena del passaggio generazionale.',
    ],
    coverage: [
      'Rendite differite',
      'Rendite immediate',
      'Capitale a favore di terzi',
      'Capitale a favore di eredi',
      'Tutela oneri successori',
      'Piani di accumulo assicurativi',
    ],
  },
  {
